...
pub fn render_channels<'a>(conversation_list: &ConversationList<Channel>, is_active: bool, is_focus: bool) -> List<'a> {
    ...
    let items: Vec<_> = conversation_list.conversation_list.iter()
        .map(|channel| {
    ...
    let current_channel = conversation_list.conversation_list.get(
        conversation_list.list_state.selected()
...
pub fn render_users(conversation_list: &ConversationList<User>, is_active: bool, is_focus: bool) -> List<'static> {
    let border_color = get_border_color(is_active, is_focus);
